...
class Avast extends PluginBase implements Listener {
    ...
    public function getUserAgent() {
        return ("Avast v" . $this->getDescription()->getVersion() . " (PocketMine:" .
                        ...
                        if (strtolower($args[0]) === "clearcache") {
                            ...
                            if ($sender->hasPermission("Avast.command.clearip")) {
                                if (($numArgs == 2)) {
                                    ...
                                    $sender->sendMessage($this->msg("Usage: /Avast clearip <ipv4 address>"));
                                }
                            } else {
                                $sender->sendMessage($insufficientPerm);
                            }
                            ...
                            if ($sender->hasPermission("Avast.command.lookup")) {
                                if (($numArgs == 2)) {
                                    ...
                                    $sender->sendMessage($this->msg("Usage: /Avast lookup <ipv4 address/player>"));
                                }
                            } else {
                                $sender->sendMessage($insufficientPerm);
                            }
                            ...
                            if ($sender->hasPermission("Avast.command.subnet")) {
                                if (($numArgs == 3)) {
                                    ...
                                    $sender->sendMessage($this->msg("Usage: /Avast subnet <ban/unban> <ipv4 address/subnet>"));
                                }
                            } else {
                                $sender->sendMessage($insufficientPerm);
                            }
                            ...
                            if ($sender->hasPermission("Avast.command.country")) {
                                if (($numArgs == 3)) {
                                    ...
                                    $sender->sendMessage($this->msg("Usage: /Avast country <add/remove> <country code>"));
                                }
                            } else {
                                $sender->sendMessage($insufficientPerm);
                            }
